package md.ceiti.dad.example.javfx_firstexample;
...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        Text caption = new Text(81, 240, s);
...
//        Scene scene1 = new Scene(group, 250, 275, Color.YELLOW);
        ...
        smileButton.setOnAction(e -> {
            mouth.setLength(-180);
            mouth.setRadiusY(40);
            caption.setText("Smile Face");
        });

        frownButton.setOnAction(e -> {
            mouth.setLength(180);
            mouth.setRadiusY(40);
            caption.setText("Frown Face");
        });

        thinkButton.setOnAction(e->{
            mouth.setRadiusY(0);
            caption.setText("Think Face");
        });
