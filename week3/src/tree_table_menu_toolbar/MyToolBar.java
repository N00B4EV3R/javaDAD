...
// Adauga butoane la toolbar
        buttonNew = addToolbarButton( myToolbar, false, "New","new", "Create a new document" );
        buttonOpen = addToolbarButton( myToolbar, true, "Open","open","Open an existing document" );
        buttonSave = addToolbarButton( myToolbar, true, "Save","save","Open an existing document" );
        myToolbar.addSeparator();
        buttonCopy = addToolbarButton( myToolbar, true, null,"copy","Copy selection to the clipboard" );
        buttonCut = addToolbarButton( myToolbar, true, null,"cut","Cut selection to the clipboard" );
        buttonPaste = addToolbarButton( myToolbar, true, null,"paste","Paste selection from the clipboard" );
...
// Creeaza un nou buton
        if( bUseImage )
            b = new JButton( new ImageIcon( sButton + ".png" ) );
        else
